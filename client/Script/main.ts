...
export const Event: Model<EventDoc> = mongoose.model<EventDoc>('Event', EventSchema);
...
const blogdata: BlogData[] = [
    {
        ...
        "imageSrc": "/assets/images/blogvolunteer.jpg",
    ...
    },
    {
        ...
        "imageSrc": "/assets/images/bloggardening.jpg",
    ...
    },
    {
        ...
        "imageSrc": "/assets/images/blogdigitalinclusion.jpg",
    ...
    let projectsData: {title: string, description: string, imageSrc: string}[] = [
        {
            ...
            imageSrc: "/assets/images/kidscodingcamp.jpg"
        },

        {
            ...
            imageSrc: "/assets/images/communitygarden.jpg"
        },

        {
            ...
            imageSrc: "/assets/images/neighborsupport.jpg"
        },

        {
            ...
            imageSrc: "/assets/images/techbasicsworkshop.jpg"
        },

        {
            ...
            imageSrc: "/assets/images/localartshowcase.jpg"
        }
    ];
...
(function() {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        GalleryLink.innerHTML = '<a class="nav-link" href="/Gallery1"><i class="fa-solid fa-image"></i> Gallery </a>';

        const HumorLink = document.createElement("li");
        HumorLink.classList.add("nav-item");
        HumorLink.innerHTML = '<a class="nav-link" href="/Humour"><i class="fa-solid fa-face-smile"></i> Humour </a>';
        ...
        LoginLink.innerHTML = '<a class="nav-link fas fa-sign-in-alt" id="login" href="/login"></a>';
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (user) {
        const DynaLink = document.querySelector(".nav-link[href='/login']") as HTMLAnchorElement | null;
        if (DynaLink) {
...
function createFooter(): void {
    ...
    const navItems = [
        { text: "Privacy Policy", icon: "fa-shield-halved", href: "/privacypolicy" },
        { text: "Terms of Service", icon: "fa-envelope-open-text", href: "/termsofservice" },
        { text: "Feedback", icon: "fa-inbox", href: "/feedback" },
    ];
